...
export default function ProjectRequestsPage() {
  ...
  const reapPending = myReap.filter(
    (r) => r.status === "PENDING" || r.status === "TRANSFERRED",
  ).length;
  const reapCompletedCount = reapCompleted?.length || 0;
  const extPending = myExt.filter(
    (r) => r.status === "PENDING" || r.status === "TRANSFERRED",
  ).length;
    ...
    <div className="prq-page">
      ...
      <div className="prq-header">
        ...
        <p className="prq-subtitle">
          Review, approve, and track all incoming project requests from
        ...
        <div className="prq-strip-item">
          <span className="prq-strip-num total">
            {Object.values(STATS).reduce(
              (s, v) => s + v.pending + v.approved + v.declined,
              0,
            )}
          </span>
      ...
      <div className="prq-cards">
        ...
        <div
          className="prq-card"
          onClick={() => navigate("/projects/office-reappropriation")}
        >
          ...
          <div className="prq-card-body">
            ...
            <div className="prq-card-content">
              ...
              <p className="prq-card-desc">
                Review fund reallocation requests submitted by PIs. Approve or
                decline transfers between sanctioned budget heads.
              </p>
        ...
        <div
          className="prq-card"
          onClick={() => navigate("/projects/project-extension")}
        >
          ...
          <div className="prq-card-body">
            ...
            <div className="prq-card-content">
              ...
              <p className="prq-card-desc">
                Review no-cost extension requests from PIs. Approve revised
                project end dates and maintain extension history.
              </p>
              <div className="prq-card-stats">
                <span className="prq-stat pending">
                  <span className="prq-stat-dot" />
