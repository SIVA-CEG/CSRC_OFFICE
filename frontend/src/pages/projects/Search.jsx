...
const dummyProjects = [
  {
    ...
    pi: "Dr. K. Senthil Kumar",
    designation: "Prof.",
    department: "CASR",
    campus: "MIT Campus",
    funding:
      "Additional Director General of Police Operations, Chennai {ADGPO}",
    cost: "1,14,00,000/-"
  },
  {
    ...
    department: "IT",
    campus: "CEG Campus",
    funding: "Chief Minister Research Grant",
    cost: "25,00,000/-"
  }
];
...
export default function Search() {
  ...
  const filtered = dummyProjects.filter((project) => {
    ...
    const fundingMatch =
      !filters.fundingAgency ||
      project.funding === filters.fundingAgency;

    const campusMatch =
      !filters.campus ||
      project.campus === filters.campus;
  ...
  return (
    <div className="search-page">
      ...
      <div className="search-header">
        ...
        <p>Search and retrieve research project information</p>
      </div>
  ...
  >
    {item.text}
        ...
        <div className="date-section">
          ...
          <div className="date-row">
            <label>Project Sanction Date</label>

            <input
              type="date"
              name="sanctionFrom"
              value={filters.sanctionFrom}
              onChange={handleChange}
            />
