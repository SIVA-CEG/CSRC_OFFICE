      ...
      <div className="edm-modal">
        ...
        <div className="edm-modal-head">
          ...
          <div className="edm-head-right">
            ...
            {!editMode ? (
              <button className="edm-btn edm-btn--edit" onClick={() => setEditMode(true)}>
              ...
              <>
                ...
                <button className="edm-btn edm-btn--cancel" onClick={() => { setForm({ ...item }); setEditMode(false); }}>
                  Cancel
                </button>
              </>
            )}
        ...
        <div className="edm-body">
          ...
          <div className="edm-action-row">
            <button className="edm-btn-update" onClick={handleSave}>Update</button>
            <button className="edm-btn-lock">Lock</button>
            <button className="edm-btn-close-modal" onClick={onClose}>Close</button>
          </div>
        </div>
      </div>
    </div>
