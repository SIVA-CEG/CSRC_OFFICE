...
import StaffOverallReportModalSA from "./StaffOverallReportModalSA";
...
const DUMMY_REQUESTS = [
  ...
  },
  {
    ...
    projectTitle: "Advanced Materials Research",
    piName: "Dr. P.T.V.Bhuvaneswari",
    orderNo: "MIT/ELEC/PA/02",
    date: "09-06-2026",
    status: "PENDING",
  },
  {
...
const TABS = [
  ...
  { key: "assigned", label: "Assigned Requests", icon: "📌" },
  { key: "completed", label: "Completed Requests", icon: "✅" },
];

export default function StaffApprovalTapal() {
  ...
  const currentRequests = filtered.filter((item) => {
    ...
    <div className="page-body">
      <div className="page-stack">
        <div>
          ...
          <div className="page-title">Staff Approval Tapals</div>
          ...
          {selected && (
            <>
              <div style={{ marginTop: 20 }}>
                <input
                  type="text"
                  placeholder="Search by staff, project, PI..."
                  value={search}
