    ...
    >
      <div className="sdmst-modal">
        <div className="sdmst-header">
          ...
          <button className="sdmst-close" onClick={onClose}>
            ✕
          </button>
        </div>

        <div className="sdmst-body">
          <div className="sdmst-banner">Read Only View</div>

          <div className="sdmst-summary">
            <div className="sdmst-summary-title">{item.projectTitle}</div>

            <div className="sdmst-summary-sub">{item.piName}</div>
          </div>
          ...
          <div className="sdmst-grid">
            ...
            <div className="sdmst-item">
              ...
              <span>{item.proceedingNo}</span>
            </div>

            <div className="sdmst-item">
              <label>Total Amount</label>
              <span>
                ₹{(item.totalAmount || item.installment || 0).toLocaleString()}
              </span>
            </div>
          </div>
          ...
          <div className="sdmst-section">
            ...
            <div className="sdmst-grid">
              {item.installments?.map((installment, index) => (
                <div key={index} className="sdmst-item">
