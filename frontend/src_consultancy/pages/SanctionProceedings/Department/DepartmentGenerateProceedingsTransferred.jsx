// PATH: frontend/src_consultancy/pages/SanctionProceedings/Department/DepartmentGenerateProceedingsTransferred.jsx
...
const DepartmentGenerateProceedingsTransferred = () => {
  const role = sessionStorage.getItem('consultancyUserRole');
  const [queue] = useState(() => loadQueue());
  const [filters, setFilters] = useState({});

  const allRows = getTransferredRows(queue, 'proceedings-department-generate', role);
  ...
  return (
    <div>
      <h1 style={{ fontSize: 22, fontWeight: 700, color: '#111827', margin: '0 0 4px' }}>Department Generate Proceedings — Transferred</h1>
...
export default DepartmentGenerateProceedingsTransferred;