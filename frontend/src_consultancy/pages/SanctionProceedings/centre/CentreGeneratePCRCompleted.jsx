// PATH: frontend/src_consultancy/pages/SanctionProceedings/Centre/CentreGeneratePCRCompleted.jsx
...
const CentreGeneratePCRCompleted = () => {
  const [queue] = useState(() => loadQueue());
  const [filters, setFilters] = useState({});

  const allRows = getCompletedRows(queue, 'proceedings-centre-generate-pcr');
  ...
  return (
    <div>
      <h1 style={{ fontSize: 22, fontWeight: 700, color: '#111827', margin: '0 0 4px' }}>Centre Generate PCR Proceedings — Completed</h1>
      <p style={{ fontSize: 13.5, color: '#6b7280', margin: '0 0 18px' }}>Fully approved by the Director — moved on to PCR Proceedings.</p>
...
export default CentreGeneratePCRCompleted;