// PATH: frontend/src_consultancy/pages/ProformaInvoice/ProformaInvoiceCompleted.jsx
...
const ProformaInvoiceCompleted = () => {
  const [queue] = useState(() => loadQueue());
  const [filters, setFilters] = useState({});

  const allRows = getCompletedRows(queue, 'proforma-invoices');
  ...
  return (
    <div>
      <h1 style={{ fontSize: 22, fontWeight: 700, color: '#111827', margin: '0 0 4px' }}>Proforma Invoice — Completed</h1>
...
export default ProformaInvoiceCompleted;