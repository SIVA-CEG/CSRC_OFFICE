...
const styles = {
  ...
  navHome: (active) => ({
    display: 'flex', alignItems: 'center', gap: 10, fontSize: 13.5, fontWeight: active ? 800 : 600,
    color: active ? '#fff' : '#4b5567',
    background: active
  ...
  navGroupLabel: (color, icon) => ({
    fontSize: 10.5, fontWeight: 800, color, textTransform: 'uppercase', letterSpacing: '0.06em',
    padding: '0 10px 10px', display: 'flex', alignItems: 'center', gap: 7,
  }),
  navGroupIcon: { fontSize: 13 },
  navGroupDot: (color) => ({
        ...
        {WORKFLOW_SECTIONS.map((key) => {
          ...
          return (
            <div key={key} className="cc-nav-group" style={styles.navGroup}>
              <div style={styles.navGroupLabel(theme.text)}>
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        '--accent-to': theme.to,
                        '--accent-shadow': `${theme.from}80`,
                        '--hover-bg': `${theme.from}14`,
                        '--hover-fg': '#1e1b3a',
                      }}
