...
export default function TDS() {
  ...
  return (
    <Layout title="TDS" subtitle="Accounts / Payments / TDS">
      <style>{css}</style>
      <div>
        ...
        <div className="uc-wrap">
          ...
          <h1 className="uc-title">TDS</h1>
          <span className="uc-badge">Coming Soon</span>
          <p className="uc-sub">
            The TDS report is under construction. This page will show
            tax-deducted-at-source entries once the module is built.
          </p>
        </div>
      </div>
    </Layout>
